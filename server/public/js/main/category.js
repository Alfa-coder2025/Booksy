...
//               ${category.showOnHomepage ? "checked" : ""} disabled>

//              <label class="form-check-label" for="toggle-${category._id}">
//             ${category.showOnHomepage ? "Shown" : "Hidden"}
//           </label>
//             </div>
//           </td>
//           <td>
...
//           data-image="/uploads/categories/${category.image || ""}"
//           data-show="${category.showOnHomepage}">
//           <i class="fa fa-pen"></i>
//         </button>
